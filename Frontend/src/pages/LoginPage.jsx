      ...
      <div className="max-w-md w-full space-y-8">
        ...
        <div className="bg-white/95 backdrop-blur-sm py-8 px-6 shadow-2xl rounded-xl border border-white/20">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center">
                ...
                />
                <label htmlFor="remember-me" className="ml-2 block text-sm text-purple-800 font-medium">
                  Remember me
                </label>
              </div>
              <div className="text-sm">
                <a href="#" className="font-semibold text-pink-600 hover:text-pink-500 transition duration-200">
          ...
          <div className="mt-6">
            <div className="relative">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-3 bg-white text-purple-600 font-medium">Or continue with</span>
              </div>
            </div>
          ...
          <p className="mt-6 text-center text-sm text-purple-700">
            ...
            <Link to="/register" className="font-bold text-pink-600 hover:text-pink-500 transition duration-200 hover:underline">
              Sign up now
            </Link>
          </p>
        </div>
